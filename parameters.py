...
# Customers
NUMBER_OF_CUSTOMERS = 5;  # number of customers
SIGNAL_RATE = 4000;  # How long time passes between signals, ms
SIGNAL_TIME = 30;  # How ling each signal lasts, transmission time, ms
SIGNAL_STRENGTH = 10;  # Radius of receiver signaling space